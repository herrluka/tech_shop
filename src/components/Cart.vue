<template>
  <div class="container main-content">
    <div class="row h-100 w-100">
      <div
        class="col-lg-8 col-xl-8 col-sm-12 col-xs-12 products-in-cart p-lg-5 p-xl-5 p-sm-0"
      >
        <div class="title">
          <span class="h3 font-weight-bold m-0">Vaša korpa</span>
          <span class="h4 font-weight-bold m-0"
            >{{ numberOfProducts }} proizvoda</span
          >
        </div>
        <hr />
              ...
              <tr v-for="product in productsInCart" :key="product.id">
                <th scope="row" class="border-0">
                  <div class="p-2 d-lg-flex d-sm-inline-block ">
                    ...
                    />
                    <div
                      class="ml-2 d-flex flex-column justify-content-center align-content-center"
                    >
                      <span
                        class="text-dark font-weight-normal text-left m-0"
                ...
                <td class="border-0 align-middle">
                  <div class="quantity-container">
                    <button
                      ...
                      @click="subtractOne(product.productId)"
                    >
                      <font-awesome-icon
                        icon="minus"
                        class="plus-minus-icons"
                      />
                    </button>
                    <input
                      type="number"
                    ...
                    <button
                      class="btn btn-success"
                      @click="addOneToChart(product.productId)"
                    >
                ...
                <td class="border-0 align-middle">
                  <strong>{{ product.price * product.quantity }} RSD</strong>
                </td>
                <td class="border-0 align-middle">
                  <button
      ...
      <div
        class="col-lg-4 col-xl-4 col-sm-12 col-xs-12 order-summary p-lg-5 p-xl-5 p-sm-0"
      >
        <div class="title">
...
export default {
  ...
  methods: {
    ...
    confirmOrder() {
      ...
      const deliverer = this.availableDeliverers.find(
